...
export const HERO = {
  ...
  microTrust: 'free · no signup · picks lock at kickoff',
};
...
export const MATCH = {
  locked: 'Cute. Logged.',
  hiddenBot: 'I committed my pick before kickoff. You see it when everyone does.',
  reveal: "Here's what I locked in before kickoff. No edits. No excuses.",
  forfeit:
