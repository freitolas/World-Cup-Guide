...
let
  ...
  ee = {
    ...
    osimhen: { ov: 86, pa: 80, sh: 88, ps: 68, dr: 80, df: 40, ph: 82, bd: [] },
    "ruben-dias": {
      ov: 88,
      pa: 72,
      sh: 54,
    ...
    kudus: { ov: 83, pa: 82, sh: 82, ps: 78, dr: 88, df: 52, ph: 76, bd: [] },
    tonali: { ov: 83, pa: 78, sh: 74, ps: 84, dr: 78, df: 78, ph: 78, bd: [] },
    lookman: { ov: 83, pa: 86, sh: 82, ps: 74, dr: 86, df: 48, ph: 72, bd: [] },
    taremi: {
      ov: 83,
      pa: 70,
      sh: 88,
